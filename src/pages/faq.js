          ...
          <section>
            <div className="inner">
              <div className="content bg-dark">
                ...
                <p>If your question hasn't been answered, feel free to reach out to us on <a className="fab" href={site.siteMetadata.twitter} target="_blank" rel="noopener noreferrer" aria-label="Mun Twitter"><i className="fab fa-twitter"></i></a> or <a href={site.siteMetadata.discord} className="fab" target="_blank" rel="noopener noreferrer" aria-label="Mun Discord"><i className="fab fa-discord"></i></a></p>
              </div>
            </div>
          </section>
      </div>
